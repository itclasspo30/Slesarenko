    ...
    <body>
        ...
        <div id="main">
            <aside class="leftAside">
                <h2>Действуй!</h2>
                <p>Отмечай выполненные цели и добавляй новые!
                </p>
            </aside>
            <section>
                <article>
                <table width="100%" border="0">
                    <tr>
                        <td><h1>Было выполнено:</h1></td> 
                        <td align="right">
                            <form method="GET" action="newTask">
                            <button type="submit">Добавить новую активную цель</button>
                            </form>
                        </td>
                        <td align="right">
                            <form method="POST" action="showEnable">
                            <button type="submit">Смотреть активные</button>
                            </form>
                        </td>
                    </tr>
                </table>
                ...
                <div class="text-article">
                    <form method="GET" name='list' action='setEnable'>
                        <c:forEach items="${tasks}" var="task">
                            <h3><input type='checkbox' name='task' value='${task.taskText}'> ${task.taskText} </h3>
                        </c:forEach>
                        <p><button type="submit">Вернуть выделенное в активные</button></p>
                    </form>
                    </div>
